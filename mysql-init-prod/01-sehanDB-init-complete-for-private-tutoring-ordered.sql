...
-- Step 2: Create tables that depend on pt_grades
...
-- Step 3: Create tables that depend on pt_students and pt_subjects
...
-- Step 4: Create pt_sessions (depends on pt_students, pt_subjects, pt_grades)
...
-- Step 5: Create pt_schedules (depends on pt_students, pt_teachers, pt_subjects, pt_session_applications)
