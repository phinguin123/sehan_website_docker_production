...
export default function AdminSettingPage() {
  ...
  useEffect(() => {
    const fetchExamEndTime = async () => {
      try {
        const result = await api.get("/api/settings/exam_end_time");
    ...
    const fetchNoticeText = async () => {
      try {
        const result = await api.get("/api/settings/report/notice_text");
    ...
    const fetchCredentialsNoticeText = async () => {
      try {
        const result = await api.get("/api/settings/credentials");
  ...
  const handleSetExamEndTime = async () => {
    ...
    try {
      await api.post("/api/settings/exam_end_time", {
        examEndTime,
  ...
  const handleSetReportNotice = async () => {
    ...
    try {
      await api.post("/api/settings/report/notice_text", { reportNotice });
