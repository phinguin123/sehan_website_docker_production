        ...
        <Card>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {teachers?.filter(teacher => teacher && teacher.teacher_id).map((teacher) => (
                  <TableRow key={teacher.teacher_id}>
                    <TableCell>{teacher.teacher_name || 'N/A'}</TableCell>
                    <TableCell>{teacher.teacher_type || 'N/A'}</TableCell>
                    <TableCell>
                      {teacher.subjects?.filter(subject => subject && subject.subject_name).map((subject) => (
                        <div
                          key={subject.subject_id}
                          style={{
                            whiteSpace: "nowrap",
